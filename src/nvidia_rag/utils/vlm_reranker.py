...
"""Multimodal (VLM) reranker implementation for NVIDIA NIMs.

Provides NVIDIAVLMRerank, a requests-based reranker that supports text + image
passages for the llama-nemotron-rerank-vl family of models.
"""
